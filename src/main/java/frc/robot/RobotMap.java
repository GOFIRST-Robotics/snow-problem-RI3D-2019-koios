...
public class RobotMap {
  ...
  public static int ballsolenoid=2;
  public static int ballright=4;
  public static int popper=1;
  public static int extender=0;
  public static int clamp_solenoid=3;
  public static int mainlift=6;
  public static int mainlift2=8;
